#!/bin/bash
# Converted from make_kick_proms.bat 12-2024 Red~Bote (Glenn Neidermeier)
...
cat 1200a-v2.b3 1300b-v2.b4 1400c-v2.b5 1500d-v2.d4 1600e-v2.d5 1700f-v2.d6 > kick_cpu.bin
./make_vhdl_prom kick_cpu.bin kick_cpu.vhd

cat 4200-a.a7 4300-b.a8 4400-c.a9 4500-d.a10 > kick_sound_cpu.bin
./make_vhdl_prom kick_sound_cpu.bin kick_sound_cpu.vhd

./make_vhdl_prom 1800g-v2.g4 kick_bg_bits_1.vhd
./make_vhdl_prom 1900h-v2.g5 kick_bg_bits_2.vhd 

cat 2600a-v2.1e 2700b-v2.1d 2800c-v2.1b 2900d-v2.1a > kick_sp_bits.bin
./make_vhdl_prom kick_sp_bits.bin kick_sp_bits.vhd
